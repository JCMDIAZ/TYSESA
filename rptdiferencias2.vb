...
Public Class rptdiferencias2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "VisionTec.rptdiferencias2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptdiferencias2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptdiferencias2 = New rptdiferencias2()
        rpt.Site = Me.Site
        Return rpt
    End Function
