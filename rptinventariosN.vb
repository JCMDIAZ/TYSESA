...
Public Class rptinventariosN
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "VisionTec.rptinventariosN.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptinventariosN
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptinventariosN = New rptinventariosN()
        rpt.Site = Me.Site
        Return rpt
    End Function
