...
Public Class rptclienteglobal2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "VisionTec.rptclienteglobal2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptclienteglobal2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptclienteglobal2 = New rptclienteglobal2()
        rpt.Site = Me.Site
        Return rpt
    End Function
