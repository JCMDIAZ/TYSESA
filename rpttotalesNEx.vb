...
Public Class rpttotalesNEx
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "VisionTec.rpttotalesNEx.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrpttotalesNEx
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpttotalesNEx = New rpttotalesNEx()
        rpt.Site = Me.Site
        Return rpt
    End Function
