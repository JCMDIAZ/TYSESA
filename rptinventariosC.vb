...
Public Class rptinventariosC
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "VisionTec.rptinventariosC.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptinventariosC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptinventariosC = New rptinventariosC()
        rpt.Site = Me.Site
        Return rpt
    End Function
