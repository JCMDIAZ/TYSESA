...
Public Class rptproductos2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "VisionTec.rptproductos2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptproductos2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptproductos2 = New rptproductos2()
        rpt.Site = Me.Site
        Return rpt
    End Function
