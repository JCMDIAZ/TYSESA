...
Public Class rptinventariosA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "VisionTec.rptinventariosA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptinventariosA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptinventariosA = New rptinventariosA()
        rpt.Site = Me.Site
        Return rpt
    End Function
