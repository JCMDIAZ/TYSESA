...
Public Class rptmovimientos2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "VisionTec.rptmovimientos2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptmovimientos2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptmovimientos2 = New rptmovimientos2()
        rpt.Site = Me.Site
        Return rpt
    End Function
