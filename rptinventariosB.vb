...
Public Class rptinventariosB
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "VisionTec.rptinventariosB.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptinventariosB
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptinventariosB = New rptinventariosB()
        rpt.Site = Me.Site
        Return rpt
    End Function
