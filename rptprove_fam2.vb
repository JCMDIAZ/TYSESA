...
Public Class rptprove_fam2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "VisionTec.rptprove_fam2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptprove_fam2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptprove_fam2 = New rptprove_fam2()
        rpt.Site = Me.Site
        Return rpt
    End Function
