...
Public Class rptproveedores2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "VisionTec.rptproveedores2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptproveedores2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptproveedores2 = New rptproveedores2()
        rpt.Site = Me.Site
        Return rpt
    End Function
