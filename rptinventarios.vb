...
Public Class rptinventarios
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "VisionTec.rptinventarios.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptinventarios
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptinventarios = New rptinventarios()
        rpt.Site = Me.Site
        Return rpt
    End Function
