...
Public Class rptclientesrutas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "VisionTec.rptclientesrutas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptclientesrutas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptclientesrutas = New rptclientesrutas()
        rpt.Site = Me.Site
        Return rpt
    End Function
